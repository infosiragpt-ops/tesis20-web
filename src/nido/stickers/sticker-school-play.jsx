...
function BackpackSticker({ size = 48, ...rest }) {
  return (
    <StickerBase size={size} {...rest}>
      <Ground cx={32} cy={56} rx={17} ry={2.4} />
      ...
      <path d="M22 44 L42 44" stroke="#e6a93c" strokeWidth="1.8" strokeLinecap="round" />
      <rect x="27" y="36" width="10" height="6" rx="2" fill="#ffc94d" {...OUTLINE} strokeWidth={2} />
      <circle cx="32" cy="47" r="1.6" fill="#e6a93c" stroke="#10233f" strokeWidth="1.2" />
      <circle cx="32" cy="25" r="3" fill="#ffffff" fillOpacity="0.6" />
      <Shine cx={20} cy={20} rx={3.6} ry={1.8} opacity={0.35} />
    </StickerBase>
  );
}
...
function PencilSticker({ size = 48, ...rest }) {
  return (
    <StickerBase size={size} {...rest}>
      ...
      <path d="M39 15.5 L46 20 L36 10 Z" fill="#dc5048" fillOpacity="0.6" stroke="none" />
      ...
      <path d="M33 13 L43 23" stroke="#ffffff" strokeWidth="1.6" strokeOpacity="0.5" strokeLinecap="round" />
      ...
      <path d="M54 20 L54 22.4 M52.8 21.2 L55.2 21.2" stroke="#29c7c9" strokeWidth="1.3" strokeLinecap="round" />
    </StickerBase>
  );
}
...
function BookOpenSticker({ size = 48, ...rest }) {
  return (
    <StickerBase size={size} {...rest}>
      <Ground cx={32} cy={54} rx={20} ry={2.4} />
      ...
      <path d="M16 40.5 Q24 39.5 30 43 M48 40.5 Q40 39.5 34 43" stroke="#c9dcea" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      ...
      <circle cx="44" cy="35.5" r="1.1" fill="#ffc94d" />
...
function PaletteSticker({ size = 48, ...rest }) {
  return (
    <StickerBase size={size} {...rest}>
      ...
      <Shade cx={30} cy={33} r={19} opacity={0.07} />
      ...
      <circle cx="21" cy="19" r="1.1" fill="#ffffff" fillOpacity="0.7" />
      <circle cx="37" cy="15" r="1.1" fill="#ffffff" fillOpacity="0.7" />
      <circle cx="46" cy="25" r="1.1" fill="#ffffff" fillOpacity="0.7" />
      <circle cx="16" cy="32" r="1.1" fill="#ffffff" fillOpacity="0.7" />
      <circle cx="23" cy="43" r="1.1" fill="#ffffff" fillOpacity="0.7" />
      <path d="M50 44 L58 36 Q60 34 58.5 32.5 Q57 31 55 33 L47 41 Z" fill="#b07b4f" {...OUTLINE} strokeWidth={1.8} />
      <path d="M48.5 42.5 L50.5 44.5" stroke="#ff6f61" strokeWidth="2.4" strokeLinecap="round" />
    </StickerBase>
  );
}
...
function HeadphonesSticker({ size = 48, ...rest }) {
  return (
    <StickerBase size={size} {...rest}>
      ...
      <path d="M16 24 Q20 14 32 13" stroke="#ffffff" strokeWidth="1.8" strokeOpacity="0.35" fill="none" strokeLinecap="round" />
      ...
      <path d="M9 40 Q9 38.4 10.6 38.4" stroke="#ffffff" strokeWidth="1.5" strokeOpacity="0.6" fill="none" strokeLinecap="round" />
      <path d="M49 40 Q49 38.4 50.6 38.4" stroke="#ffffff" strokeWidth="1.5" strokeOpacity="0.6" fill="none" strokeLinecap="round" />
      ...
      <path d="M22 44 L22 47 M25 42 L25 49 M28 44.5 L28 46.5" stroke="#29c7c9" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M36 44.5 L36 46.5 M39 42 L39 49 M42 44 L42 47" stroke="#29c7c9" strokeWidth="1.8" strokeLinecap="round" />
    </StickerBase>
  );
}
...
function ToothSticker({ size = 48, ...rest }) {
  return (
    <StickerBase size={size} {...rest}>
      ...
      <path d="M20 44 Q22 49 23 51 M44 44 Q42 49 41 51" stroke="#d3e2ec" strokeWidth="1.6" fill="none" strokeLinecap="round" />
      <Shine cx={23} cy={14} rx={4.4} ry={2} opacity={0.8} />
      ...
      <path d="M14 16 L14.7 17.8 L16.5 18.5 L14.7 19.2 L14 21 L13.3 19.2 L11.5 18.5 L13.3 17.8 Z" fill="#29c7c9" fillOpacity="0.7" stroke="none" />
    </StickerBase>
  );
}
...
function BalloonSticker({ size = 48, ...rest }) {
  return (
    <StickerBase size={size} {...rest}>
      ...
      <path d="M20 36 Q26 43 36 43.5 Q30 45 25 42 Q21 39.5 20 36 Z" fill="#dc5048" fillOpacity="0.7" stroke="none" />
      <path d="M29 41 L35 41 L33.5 45 L30.5 45 Z" fill="#dc5048" {...OUTLINE} strokeWidth={1.8} />
      <Shine cx={25} cy={16} rx={4.5} ry={6} opacity={0.45} tilt={-14} />
      <circle cx="27" cy="26" r="1.9" fill="#10233f" />
      <circle cx="37" cy="26" r="1.9" fill="#10233f" />
      <circle cx="27.7" cy="25.3" r="0.7" fill="#ffffff" />
      <circle cx="37.7" cy="25.3" r="0.7" fill="#ffffff" />
...
function BasketballSticker({ size = 48, ...rest }) {
  return (
    <StickerBase size={size} {...rest}>
      <Ground cx={32} cy={56.5} rx={15} ry={2.4} />
      <circle cx="32" cy="32" r="22" fill="#ffc94d" {...OUTLINE} />
      <Shade cx={32} cy={32} r={22} opacity={0.1} />
      ...
      <Shine cx={24} cy={18} rx={4.5} ry={2.4} opacity={0.5} />
    </StickerBase>
  );
}
...
function GameControllerSticker({ size = 48, ...rest }) {
  return (
    <StickerBase size={size} {...rest}>
      ...
      <path d="M12 42 Q20 44.5 32 44.5 Q44 44.5 52 42 Q48 46.5 42 45 L22 45 Q16 46.5 12 42 Z" fill="#7a55c9" fillOpacity="0.6" stroke="none" />
      ...
      <circle cx="41.3" cy="26.3" r="0.8" fill="#ffffff" fillOpacity="0.8" />
      <circle cx="47.3" cy="31.3" r="0.8" fill="#ffffff" fillOpacity="0.8" />
      <path d="M28 24 Q32 21 36 24" {...LINE} strokeWidth={2} stroke="#ffffff" />
      <Shine cx={14} cy={24} rx={3} ry={1.5} opacity={0.35} tilt={-24} />
    </StickerBase>
  );
}
...
function MicrophoneSticker({ size = 48, ...rest }) {
  return (
    <StickerBase size={size} {...rest}>
      ...
      <Shine cx={28} cy={11.5} rx={2.6} ry={1.3} opacity={0.5} />
      ...
      <path d="M10 26 L10.7 27.8 L12.5 28.5 L10.7 29.2 L10 31 L9.3 29.2 L7.5 28.5 L9.3 27.8 Z" fill="#ffc94d" fillOpacity="0.8" stroke="none" />
    </StickerBase>
  );
}
