export const CAREER_AREAS = [
  {
    ...
    description:
      "Diseño, construcción y optimización de sistemas, infraestructura, software y procesos.",
    careers: [
  ...
  },
  {
    ...
    name: "Negocios, economía y gestión",
    description:
      "Dirección de organizaciones, mercados, finanzas, talento y operaciones nacionales e internacionales.",
    careers: [
  ...
  },
  {
    ...
    description:
      "Prevención, diagnóstico, tratamiento, rehabilitación y gestión de la salud humana.",
    careers: [
  ...
  {
    id: "ciencias-exactas-naturales",
    name: "Ciencias exactas y naturales",
    description:
      "Investigación de la materia, la vida, el planeta, el universo y los modelos que los explican.",
    careers: [
      "Astronomía",
      "Biología",
      "Bioquímica",
  ...
  {
    id: "sociales-humanidades",
    name: "Ciencias sociales y humanidades",
    description:
      "Estudio de las sociedades, culturas, lenguas, ideas, memoria y comportamiento humano.",
    careers: [
      "Antropología",
      "Arqueología",
  ...
  {
    id: "derecho-politica",
    name: "Derecho, política y asuntos públicos",
    description:
      "Sistemas jurídicos, gobierno, justicia, seguridad ciudadana y diseño de políticas públicas.",
    careers: [
      "Ciencia Política",
      "Criminalística",
      "Criminología",
  ...
  },
  {
    ...
    description:
      "Aprendizaje, docencia, gestión educativa e inclusión en todas las etapas de formación.",
    careers: [
      "Educación Artística",
      "Educación Especial",
      "Educación Física",
  ...
  {
    id: "arquitectura-diseno-artes",
    name: "Arquitectura, diseño y artes",
    description:
      "Creación de espacios, objetos, experiencias y expresiones visuales, escénicas y sonoras.",
    careers: [
      "Animación Digital",
      "Arquitectura",
      "Artes Escénicas",
  ...
  },
  {
    ...
    name: "Comunicación, medios y contenidos",
    description:
      "Creación y gestión de mensajes, marcas, audiencias, medios y narrativas digitales.",
    careers: [
      ...
      "Publicidad",
      "Relaciones Públicas",
      "Sonido y Producción Audiovisual",
    ],
  },
  {
    id: "agroambiente-veterinaria",
    name: "Agro, ambiente y veterinaria",
    description:
      "Producción sostenible, recursos naturales, alimentación, biodiversidad y salud animal.",
    careers: [
      "Acuicultura",
      "Agroecología",
      "Agronomía",
  ...
  {
    id: "turismo-hospitalidad-deporte",
    name: "Turismo, hospitalidad y deporte",
    description:
      "Experiencias, destinos, alimentos, recreación, rendimiento y gestión de servicios.",
    careers: [
  ...
  {
    id: "seguridad-defensa-transporte",
    name: "Seguridad, defensa y transporte",
    description:
      "Protección, prevención de riesgos, movilidad, operaciones y respuesta ante emergencias.",
    careers: [
  ...
  {
    id: "interdisciplinarias-emergentes",
    name: "Carreras interdisciplinarias y emergentes",
    description:
      "Campos que integran tecnología, ciencia, sociedad y nuevos modelos de innovación.",
    careers: [
      "Bioinformática",
      "Ciencia Cognitiva",
      "Ciencia de Datos",
...
export const TEACHERS = [
  ...
  },
  {
    ...
    photo: "/assets/docentes/diego-salas-v1.jpg",
  },
  {
    id: "mariana-torres",
    name: "Mariana Torres",
